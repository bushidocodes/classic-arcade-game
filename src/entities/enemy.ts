import { NUM_COLS, SPRITE_X_OFFSET, SPRITE_Y_OFFSET, TILE_HEIGHT, TILE_WIDTH } from "../config.js";
...
export class Enemy {
  ...
  render(ctx: CanvasRenderingContext2D): void {
    ...
    if (this.speed > 0) {
      ...
      ctx.scale(-1, 1);
      ctx.drawImage(img, -img.width / 2 + SPRITE_X_OFFSET, -img.height / 2 + SPRITE_Y_OFFSET);
      ctx.restore();
    }
  }
